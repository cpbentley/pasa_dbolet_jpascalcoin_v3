...
public class PascalCoinClientNoLogger implements PascalCoinClient {
   ...
   Retrofit getRetrofit(Integer logLevel) {
      if (this.retrofit == null) {
         ...
         this.retrofit = new Retrofit.Builder().baseUrl(baseUrl).addConverterFactory(GsonConverterFactory.create()).client(httpClient.build()).build();
      }
      return retrofit;
   }

   public PascalCoinClientNoLogger() {
      this(PascalCoinConstants.DEFAULT_URL, PascalCoinConstants.DEFAULT_MAINNET_PORT, 0);
   }

   public PascalCoinClientNoLogger(String server, Short port) {
      this(server, port, 0);
   }

   public PascalCoinClientNoLogger(String server, Short port, Integer log) {
      super();
   ...
   @Override
   public Operation changeAccountInfo(Integer account_target, Integer account_signer, String newEncPubKey, String newB58PubKey, String newName, Short new_type, Double fee, byte[] payload, PayLoadEncryptionMethod payloadMethod, String pwd) {
   ...
   @Override
   public Operation changeKey(Integer account, Integer account_signer, String newEncPubKey, String newB58PubKey, Double fee, byte[] payload, PayLoadEncryptionMethod payloadMethod, String pwd) {
      if (newEncPubKey != null && newB58PubKey != null)
         throw new IllegalArgumentException("Cannot specify both newEncPubKey and newB58PubKey");
      Operation result = null;
      Map<String, Object> body = getRPCBody();
   ...
   public String payloadEncrypt(String payload, String payloadMethod, String pwd, String encPubKey, String b58PubKey) {
      if (payload == null || payloadMethod == null)
